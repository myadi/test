...
class RuleForm extends JFrame
{
	...
	public RuleForm(LoginForm loginForm, RegisterForm registerForm,JDBCManager jdbcObj,UploadForm upload)throws Exception
	{
		...
		JLabel jLabel2 = new JLabel("* In first line of the resume type your full name.");
		JLabel jLabel3 = new JLabel("* In the second line type your date of birth in the format of yyyy-mm-dd");
		JLabel jLabel4 = new JLabel("* In the third line mention your gender by a single letter, either m or f");
		JLabel jLabel5 = new JLabel("* In the fourth line type your full address");
		JLabel jLabel6 = new JLabel("* In the Fifth line type your qualification");
		JLabel jLabel7 = new JLabel("* If you are a post graduate type the post graduate course as MS MTech PhD FIET DFET");
		JLabel jLabel8 = new JLabel("* In the Sixth line type your work designation of your previous job");
		JLabel jLabel9 = new JLabel("* In the seventh line type in your number of years of experience");
		JLabel jLabel10 = new JLabel("* In the eighth line type in what job you want to apply for as principal,head of department,staff,lab assistant,peon");
